...
## Getting started
Download the script (map2prot_v1.0.0.R) and the example files (4f5s_A.fasta and peptides.txt).
Follow the instructions in the script header.
Review the text output in the R console, checking for any warnings.
Review the graphical output. It should look like example_output.jpg.
